                ...
                <li key={uid} className="flex items-center gap-3 px-4 py-3">
                  ...
                  {canDemote ? (
                    <button
                      ...
                      onClick={() => setRole.mutate({ userId: uid, role: 'SUBSCRIBER' })}
                    >
                ...
                <li key={uid} className="flex items-center gap-3 px-4 py-3">
                  ...
                  {canPromote ? (
                    <button
                      ...
                      disabled={setRole.isPending}
                      className={cn(
                        'shrink-0 rounded-lg border px-2.5 py-1 text-xs font-semibold transition disabled:opacity-50',
