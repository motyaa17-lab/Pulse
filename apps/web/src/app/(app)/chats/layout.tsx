...
export default function ChatsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mobile-chats-shell relative flex min-h-0 w-full flex-1 flex-col overflow-hidden bg-surface text-ink dark:bg-[rgb(var(--tg-bg))] dark:text-white md:h-[100dvh] md:max-h-[100dvh] md:flex-row">
      ...
      <div
        className={cn(
          'flex h-full min-h-0 w-[min(100%,420px)] max-w-full shrink-0 flex-col overflow-hidden border-r border-line/60 bg-surface-muted transition-[transform] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] dark:border-white/[0.10] dark:bg-[rgb(var(--tg-panel))] md:relative md:z-20 md:translate-x-0',
