    ...
    5643: (e, r, o) => {
      ...
      let ep = ((e, ...r) => {
        ...
        let e = w('color'),
          ...
          es = () => [$, 'screen', 'full', 'dvw', 'lvw', 'svw', 'min', 'max', 'fit', ...G()],
          en = () => [$, 'screen', 'full', 'lh', 'dvh', 'lvh', 'svh', 'min', 'max', 'fit', ...G()],
          ea = () => [e, R, Q],
        ...
        return {
          ...
          classGroups: {
            ...
            'text-decoration-thickness': [{ decoration: [I, 'from-font', 'auto', R, B] }],
            ...
            'bg-image': [
              {
                bg: [
                  'none',
                  {
                    linear: [{ to: ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, O, R, Q],
                    radial: ['', R, Q],
                    conic: [O, R, Q],
                  },
                  Z,
            ...
            transition: [
              { transition: ['', 'all', 'colors', 'opacity', 'shadow', 'transform', 'none', R, Q] },
            ],
            ...
            'will-change': [{ 'will-change': ['auto', 'scroll', 'contents', 'transform', R, Q] }],
            fill: [{ fill: ['none', ...ea()] }],
