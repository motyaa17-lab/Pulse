    ...
    2838: (t, e, s) => {
      ...
      let c = { type: 'error', data: 'parser error' },
        ...
        d = ({ type: t, data: e }, s, r) => {
          ...
          if (l && (e instanceof ArrayBuffer || p(e)))
            if (s) return r(e);
      ...
      let _ = 'function' == typeof ArrayBuffer,
        b = (t, e) => {
          if ('string' != typeof t) return { type: 'message', data: k(t, e) };
          let s = t.charAt(0);
          return 'b' === s
            ? { type: 'message', data: v(t.substring(1), e) }
            : h[s]
              ? t.length > 1
      ...
      function A(t) {
        if (t) {
          var e = t;
          for (var s in A.prototype) e[s] = A.prototype[s];
          return e;
        }
      }
      ...
      function N(t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = C.bind(O)), (t.clearTimeoutFn = B.bind(O)))
          : ((t.setTimeoutFn = O.setTimeout.bind(O)), (t.clearTimeoutFn = O.clearTimeout.bind(O)));
      }
      function x() {
      ...
      class L extends A {
        ...
        onData(t) {
          let e = b(t, this.socket.binaryType);
          this.onPacket(e);
        }
        onPacket(t) {
      ...
      class P extends L {
        ...
        uri() {
          let t = this.opts.secure ? 'https' : 'http',
            e = this.query || {};
          return (
            !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = x()),
      ...
      class I extends A {
        ...
        _create() {
          ...
          'undefined' != typeof document &&
            ((this._index = I.requestsCount++), (I.requests[this._index] = this));
        }
        _onError(t) {
        ...
        _cleanup(t) {
          if (void 0 !== this._xhr && null !== this._xhr) {
            if (((this._xhr.onreadystatechange = D), t))
              try {
                this._xhr.abort();
              } catch (t) {}
            ('undefined' != typeof document && delete I.requests[this._index], (this._xhr = null));
          }
        }
        _onLoad() {
        ...
        'undefined' != typeof document &&
          ('function' == typeof attachEvent
            ...
            : 'function' == typeof addEventListener &&
              addEventListener('onpagehide' in O ? 'pagehide' : 'unload', F, !1)));
      let V = (function () {
        let t = H({ xdomain: !1 });
      ...
      class M extends U {
        ...
        request(t = {}) {
          return (Object.assign(t, { xd: this.xd }, this.opts), new I(H, this.uri(), t));
        }
      }
      function H(t) {
        let e = t.xdomain;
      ...
      class W extends L {
        ...
        uri() {
          let t = this.opts.secure ? 'wss' : 'ws',
            e = this.query || {};
          return (
            this.opts.timestampRequests && (e[this.opts.timestampParam] = x()),
            this.supportsBinary || (e.b64 = 1),
            this.createUri(t, e)
          );
        }
      }
      let Y = O.WebSocket || O.MozWebSocket;
      class z extends W {
        createSocket(t, e, s) {
                      ...
                      transform(a, h) {
                        for (s.push(a); ; ) {
                          if (0 === r) {
                            ...
                            if (w(s) < n) break;
                            let t = E(s, n);
                            (h.enqueue(b(o ? t : i.decode(t), e)), (r = 0));
                          }
                          if (0 === n || n > t) {
                            h.enqueue(c);
                            break;
                  ...
                  n = new TransformStream({
                    transform(t, e) {
                      ...
                      ((s = (s) => {
                        ...
                        u && t.data instanceof Blob
                          ? t.data.arrayBuffer().then(y).then(s)
                          : l && (t.data instanceof ArrayBuffer || p(t.data))
                            ? s(y(t.data))
                            : d(t, !1, (t) => {
      ...
      let $ = { websocket: z, webtransport: J, polling: M },
        Q =
      ...
      function G(t) {
        ...
        -1 != s &&
          -1 != r &&
          (t = t.substring(0, s) + t.substring(s, r).replace(/:/g, ';') + t.substring(r, t.length));
        let i = Q.exec(t || ''),
          n = {},
          o = 14;
        for (; o--; ) n[X[o]] = i[o] || '';
          ...
          (N(this, e),
            ...
            Z &&
              ...
              'localhost' !== this.hostname &&
                ...
                tt.push(this._offlineEventListener))),
        ...
        _onClose(t, e) {
          if (
            ...
            if (
              ...
              let t = tt.indexOf(this._offlineEventListener);
              -1 !== t && tt.splice(t, 1);
            }
      ...
      tr.protocol;
      let ti = 'function' == typeof ArrayBuffer,
        tn = Object.prototype.toString,
        to =
          'function' == typeof Blob ||
          ('undefined' != typeof Blob && '[object BlobConstructor]' === tn.call(Blob)),
        ta =
          'function' == typeof File ||
          ('undefined' != typeof File && '[object FileConstructor]' === tn.call(File));
      function th(t) {
        return (
          (ti &&
            (t instanceof ArrayBuffer ||
          ...
          (to && t instanceof Blob) ||
          (ta && t instanceof File)
        );
      }
      let tc = [
          'connect',
      ...
      class tp extends A {
        ...
        decodeString(t) {
          ...
          if (s.type === n.BINARY_EVENT || s.type === n.BINARY_ACK) {
            ...
            let n = Number(i);
            if (!tf(n) || n < 0) throw Error('Illegal attachments');
          ...
          if (t.charAt(++e)) {
            ...
            if (tp.isPayloadValid(s.type, r)) s.data = r;
        ...
        static isPayloadValid(t, e) {
          switch (t) {
            ...
            case n.CONNECT_ERROR:
              return 'string' == typeof e || ty(e);
            case n.EVENT:
            case n.BINARY_EVENT:
              return (
                Array.isArray(e) &&
                ('number' == typeof e[0] || ('string' == typeof e[0] && -1 === tc.indexOf(e[0])))
              );
            case n.ACK:
            case n.BINARY_ACK:
      ...
      class tb extends A {
        ...
        subEvents() {
          ...
          let t = this.io;
          this.subs = [
            tm(t, 'open', this.onopen.bind(this)),
            tm(t, 'packet', this.onpacket.bind(this)),
            tm(t, 'error', this.onerror.bind(this)),
            tm(t, 'close', this.onclose.bind(this)),
          ];
        }
        get active() {
          return !!this.subs;
        ...
        emit(t, ...e) {
          var s, r, i;
          if (t_.hasOwnProperty(t)) throw Error('"' + t.toString() + '" is a reserved event name');
      ...
      class tk extends A {
        ...
        onopen() {
          ...
          let t = this.engine;
          this.subs.push(
            tm(t, 'ping', this.onping.bind(this)),
            tm(t, 'data', this.ondata.bind(this)),
            tm(t, 'error', this.onerror.bind(this)),
            tm(t, 'close', this.onclose.bind(this)),
            tm(this.decoder, 'decoded', this.ondecoded.bind(this)),
          );
        }
        onping() {
          this.emitReserved('ping');
        ...
        socket(t, e) {
          ...
          return (
            s
              ...
              : ((s = new tb(this, t, e)), (this.nsps[t] = s)),
            s
          );
        }
        _destroy(t) {
      ...
      function tE(t, e) {
        ...
        return (
          e.forceNew || e['force new connection'] || !1 === e.multiplex || a
            ? (s = new tk(i, e))
            : (tw[n] || (tw[n] = new tk(i, e)), (s = tw[n])),
          r.query && !e.query && (e.query = r.queryKey),
          s.socket(r.path, e)
        );
      }
      Object.assign(tE, { Manager: tk, Socket: tb, io: tE, connect: tE });
    },
    7541: (t, e, s) => {
      var r = s(3041);
      (s.o(r, 'useParams') &&
