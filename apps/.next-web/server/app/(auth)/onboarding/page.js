(() => {
  ...
  ((a.id = 134),
    ...
    (a.modules = {
      ...
      22529: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 90687));
      },
      25493: (a, b, c) => {
        'use strict';
        c.d(b, { n: () => d });
      ...
      54163: (a, b, c) => {
        ...
        let H = {
                    ...
                    children: [
                      'onboarding',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 56185)),
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(auth)\\onboarding\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      56185: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(auth)\\\\onboarding\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
          'C:\\telegram-clone\\apps\\web\\src\\app\\(auth)\\onboarding\\page.tsx',
          'default',
      ...
      90687: (a, b, c) => {
        ...
        function i() {
          let a = (0, e.useRouter)();
          return (
            (0, g.n)((a) => a.accessToken),
            (0, g.n)((a) => a.hasHydrated),
            (0, d.jsxs)(f.P.div, {
