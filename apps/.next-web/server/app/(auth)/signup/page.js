(() => {
  ...
  ((a.id = 271),
    ...
    (a.modules = {
      ...
      10046: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 61204));
      },
      10846: (a) => {
        'use strict';
      ...
      14362: (a, b, c) => {
        ...
        function o() {
          let a = (0, g.useRouter)(),
            ...
            q = async (c) => {
              try {
                let d = await (0, k.nr)('/auth/register', {
                  method: 'POST',
                  body: {
                    email: c.email,
                    username: c.username,
                ...
                (console.error('Signup failed', a),
                  p('root', {
                    message:
                      a instanceof k.hD
                        ? `${a.message} (HTTP ${a.status})`
                        : `Could not reach API server at ${k.H$}`,
                  }));
              }
            };
              ...
              (0, d.jsxs)('form', {
                ...
                children: [
                  ...
                  (0, d.jsx)('button', {
                    ...
                    children: o ? 'Creating…' : 'Create account',
                  }),
                ],
              }),
              (0, d.jsxs)('p', {
      ...
      50214: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 14362));
      },
      50753: (a, b, c) => {
        'use strict';
        c.d(b, { Providers: () => m });
      ...
      61204: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(auth)\\\\signup\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      76961: (a, b, c) => {
        ...
        let H = {
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(auth)\\signup\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 840], () => b((b.s = 76961)));
  module.exports = c;
})();
