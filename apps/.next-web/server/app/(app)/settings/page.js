    ...
    (a.modules = {
      ...
      734: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(app)\\\\settings\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      6224: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 91124));
      },
      10846: (a) => {
        'use strict';
      ...
      64933: (a, b, c) => {
        ...
        let H = {
                    ...
                    children: [
                      'settings',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 734)),
                              'C:\\telegram-clone\\apps\\web\\src\\app\\(app)\\settings\\page.tsx',
                            ],
                          },
                        ],
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(app)\\settings\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      91124: (a, b, c) => {
        ...
        var d = c(78157),
          ...
          m = c(53704);
        function n() {
          let a = (0, h.n)((a) => a.theme),
            b = (0, h.n)((a) => a.setTheme),
            c = (0, i.n)((a) => a.clear),
            e = (0, i.n)((a) => a.refreshToken),
            n = (0, l.n)((a) => a.language),
            o = (0, l.n)((a) => a.setLanguage),
            p = (0, m.k)(),
            q = (0, g.useRouter)(),
            r = async () => {
              try {
                e &&
                  (await (0, j.nr)('/auth/logout', { method: 'POST', body: { refreshToken: e } }));
              } catch {}
              ((0, k.G1)(), c(), q.replace('/login'));
            };
          return (0, d.jsxs)('div', {
            ...
            children: [
              ...
              (0, d.jsxs)('section', {
                ...
                children: [
                  (0, d.jsx)('h2', {
                    ...
                    children: p('appearance'),
                  }),
                  (0, d.jsx)('div', {
                    className: 'flex flex-wrap gap-2',
                    children: ['light', 'dark', 'system'].map((c) =>
                      (0, d.jsx)(
                        'button',
                        {
                          type: 'button',
                          onClick: () => b(c),
                          className: `rounded-full border px-3 py-1 text-xs capitalize ${a === c ? 'border-accent bg-accent/10 text-ink' : 'border-line text-ink-muted hover:text-ink'}`,
                          children: c,
                        },
                        c,
                      ),
              ...
              (0, d.jsxs)('section', {
                ...
                children: [
                  ...
                  (0, d.jsx)('div', {
                    className: 'flex flex-wrap gap-2',
                    children: ['en', 'ru'].map((a) =>
                      (0, d.jsx)(
                        'button',
                        {
                          type: 'button',
                          onClick: () => o(a),
                          className: `rounded-full border px-3 py-1 text-xs uppercase ${n === a ? 'border-accent bg-accent/10 text-ink' : 'border-line text-ink-muted hover:text-ink'}`,
                          children: a,
                        },
                        a,
                      ),
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 135, 627], () => b((b.s = 64933)));
  module.exports = c;
})();
