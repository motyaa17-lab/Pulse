(() => {
  ...
  ((a.id = 267),
    ...
    (a.modules = {
      ...
      17369: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 45712));
      },
      19121: (a) => {
        'use strict';
      ...
      30521: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 83634));
      },
      33873: (a) => {
        'use strict';
      ...
      45712: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(app)\\\\users\\\\[userId]\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      83634: (a, b, c) => {
        ...
        var d = c(78157),
          ...
          j = c(15351);
        function k() {
          let a = (0, g.useParams)().userId,
            { data: b, isLoading: c } = (0, h.I)({
              queryKey: ['user', a],
              queryFn: () => (0, i.nr)(`/users/${a}`),
            }),
            e = b?.displayName ?? b?.username ?? (c ? 'Loading…' : 'User'),
            k = e.slice(0, 1).toUpperCase() || '?';
          return (0, d.jsxs)('div', {
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 135, 296, 627], () => b((b.s = 96321)));
  module.exports = c;
})();
