(() => {
  ...
  ((a.id = 781),
    ...
    (a.modules = {
      ...
      37764: (a, b, c) => {
        ...
        function k() {
          let a = (0, g.jE)(),
            { data: b } = (0, h.I)({
              queryKey: ['sessions'],
              queryFn: () => (0, j.nr)('/sessions'),
            }),
            c = (0, i.n)({
              mutationFn: (a) => (0, j.nr)(`/sessions/${a}`, { method: 'DELETE' }),
              onSuccess: () => a.invalidateQueries({ queryKey: ['sessions'] }),
            }),
            e = (0, i.n)({
              mutationFn: () => (0, j.nr)('/sessions/revoke-others', { method: 'POST' }),
              onSuccess: () => a.invalidateQueries({ queryKey: ['sessions'] }),
            });
          return (0, d.jsxs)('div', {
                          ...
                          (0, d.jsxs)('div', {
                            children: [
                              (0, d.jsx)('p', {
                                ...
                                children: a.userAgent ?? 'Unknown device',
                              }),
                              (0, d.jsx)('p', {
                                className: 'text-xs text-ink-muted',
                                children: a.ip ?? 'IP unknown',
                              }),
                              (0, d.jsxs)('p', {
      ...
      43856: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 57046));
      },
      55511: (a) => {
        'use strict';
      ...
      57046: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(app)\\\\sessions\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      78389: (a, b, c) => {
        ...
        let H = {
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(app)\\sessions\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      78704: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 37764));
      },
      79428: (a) => {
        'use strict';
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 135, 627], () => b((b.s = 78389)));
  module.exports = c;
})();
