(() => {
  ...
  ((a.id = 101),
    ...
    (a.modules = {
      ...
      39512: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 78550));
      },
      41025: (a) => {
        'use strict';
      ...
      49240: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 95180));
      },
      55511: (a) => {
        'use strict';
      ...
      78550: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(app)\\\\profile\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      86893: (a, b, c) => {
        ...
        let H = {
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(app)\\profile\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      95180: (a, b, c) => {
        ...
        function n() {
          let a = (0, h.jE)(),
            b = (0, m.n)((a) => a.accessToken),
            c = (0, m.n)((a) => a.sessionId),
            { data: e, isLoading: n } = (0, i.I)({
              queryKey: ['me'],
              queryFn: () => (0, k.nr)('/users/me'),
            }),
            [o, p] = (0, g.useState)(''),
            [q, r] = (0, g.useState)(''),
            [s, t] = (0, g.useState)(''),
            [u, v] = (0, g.useState)(null),
            [w, x] = (0, g.useState)(null),
            [y, z] = (0, g.useState)(!1),
            A = (0, j.n)({
              mutationFn: (a) => (0, k.nr)('/users/me', { method: 'PATCH', body: a }),
              onSuccess: (b) => {
                a.setQueryData(['me'], b);
              },
            }),
            B = (0, j.n)({
              mutationFn: () =>
                (0, k.nr)('/users/me', {
                  method: 'PATCH',
                  body: {
                    displayName: o.trim() || null,
                    username: q.trim() || null,
                    bio: s.trim() || null,
                    avatarUrl: u,
                  },
                }),
            ...
            C = async (a) => {
              if (!b) throw Error('Not authenticated');
              if ((x(null), !a.type.startsWith('image/')))
                return void x('Please choose an image file.');
              if (a.size > 5242880) return void x('Image is too large. Max 5MB.');
              z(!0);
              let d = new FormData();
              (d.append('file', a), d.append('kind', 'image'));
              let e = { Authorization: `Bearer ${b}` };
              c && (e['x-session-fingerprint'] = c);
              let f = await fetch(`${k.H$}/media/upload`, { method: 'POST', headers: e, body: d });
              try {
                if (!f.ok) throw Error('upload failed');
                let a = await f.json();
                (v(a.url), await A.mutateAsync({ avatarUrl: a.url }));
              } catch {
                x('Upload failed. Please try again.');
              } finally {
                z(!1);
              }
            },
            D = (e?.displayName ?? e?.username ?? 'Me').slice(0, 1).toUpperCase();
          return (0, d.jsxs)('div', {
            ...
            children: [
              ...
              (0, d.jsxs)('section', {
                ...
                children: [
                      ...
                      (0, d.jsxs)('div', {
                        ...
                        children: [
                          (0, d.jsx)('div', {
                            ...
                            children: e?.displayName ?? e?.username ?? (n ? 'Loading…' : '—'),
                          }),
                          (0, d.jsxs)('div', {
                  ...
                  w && (0, d.jsx)('p', { className: 'mt-2 text-sm text-red-500', children: w }),
                  (0, d.jsxs)('div', {
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 135, 296, 627], () => b((b.s = 86893)));
  module.exports = c;
})();
