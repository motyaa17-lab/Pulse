    ...
    (a.modules = {
      ...
      14144: (a, b, c) => {
        ...
        let d = (0, c(25459).registerClientReference)(
          function () {
            throw Error(
              'Attempted to call the default export of "C:\\\\telegram-clone\\\\apps\\\\web\\\\src\\\\app\\\\(app)\\\\chats\\\\page.tsx" from the server, but it\'s on the client. It\'s not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.',
            );
          },
      ...
      45066: (a, b, c) => {
        ...
        function l() {
          ((0, f.useRouter)(), (0, f.useSearchParams)().get('start'), (0, g.jE)());
          let a = (0, j.k)(),
            { data: b, isLoading: c } = (0, h.I)({
              queryKey: ['chats', ''],
              queryFn: () => (0, i.nr)('/chats'),
            });
          return c
            ? (0, d.jsxs)('div', {
                className: 'flex h-full flex-col items-center justify-center px-6 text-center',
      ...
      77062: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 45066));
      },
      79428: (a) => {
        'use strict';
      ...
      85310: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 14144));
      },
      86439: (a) => {
        'use strict';
      ...
      97365: (a, b, c) => {
        ...
        let H = {
          ...
          I = ['C:\\telegram-clone\\apps\\web\\src\\app\\(app)\\chats\\page.tsx'],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [263, 914, 135, 296, 476, 627, 33], () => b((b.s = 97365)));
  module.exports = c;
})();
