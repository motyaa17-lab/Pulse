// File: C:\telegram-clone\apps\web\src\app\(auth)\layout.tsx
import * as entry from '../../../../web/src/app/(auth)/layout.js';
import type {
  ResolvingMetadata,
  ResolvingViewport,
} from 'next/dist/lib/metadata/types/metadata-interface.js';

type TEntry = typeof import('../../../../web/src/app/(auth)/layout.js');
