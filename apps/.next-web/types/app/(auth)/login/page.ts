// File: C:\telegram-clone\apps\web\src\app\(auth)\login\page.tsx
import * as entry from '../../../../../web/src/app/(auth)/login/page.js';
import type {
  ResolvingMetadata,
  ResolvingViewport,
} from 'next/dist/lib/metadata/types/metadata-interface.js';

type TEntry = typeof import('../../../../../web/src/app/(auth)/login/page.js');
